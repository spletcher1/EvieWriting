...
Together, these data demonstrate that enhanced EB neural activity promotes longevity through ER2 and ER4 neurons, supporting the notion that the ellipsoid body is an instructive generator of lifespan-modulating signals. 
...
Flies of both sexes were pre-treated with light for 1 week to match TAG assay condiditions before being flipped onto 2\% agar, a hydrating but non-nutritive medium. 
...
Unlike the closed-loop FLIC, this open-loop design delivered light on a pre-programmed schedule regardless of fly po67vwFNpP4i9aYTbsition, dissociating valence from sucrose contact or response-contingent stimulation.

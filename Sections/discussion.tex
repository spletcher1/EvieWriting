...
Previous work showed that ER2 and ER4 neurons are required for death perception to modulate lifespan, establishing these cells as a neural substrate through which sensory experience can influence aging \citep{gendron2023}. 
...
Interestingly, we previously found that ER2 activation via the heat-gated channel TRPA1 extended lifespan, which we have recapitulated here using the light-gated CsChrimson channelrhodopsin. 
By contrast, simultaneous activation of ER2/ER4 neurons using TRPA1 reduced lifespan \citep{gendron2023}, a discrepancy that may reflect the context-sensitivity of manipulations involving ER4, as observed in our valence assays.

We also show that distinct EB manipulations converge on increased lifespan through divergent molecular states, as bulk head transcriptomics after one week of treatment revealed that ER2 activation, ER4d inhibition, and ER2/ER4 co-activation did not produce a common downstream transcriptional program. 

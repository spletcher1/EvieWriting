...
\hl{need to cite more diversity here.  Not just our papers.  Leiser maybe. Maybe Mike Garrett and Rich miller?}
...
The EB is subdivided into concentric domains innervated by six major classes of ring neurons (termed "ER" or "R" neurons) that process visual, thermal, mechanosensory, and circadian information to drive behavioral outputs\citep{hulse2021, buhl2021, yan2023}. Recent work has implicated this structure in aging biology.
...
\hl{not sure what you reference in the comment below.  However, I don't think you close the argument fully. Why are instructive mechanisms more translational? You don't have to be right, but you need to make this link clearer.}
...
Activation of R2 neurons, inhibition of R4d neurons, and simultaneous activation of R2 and R4 neurons each extends lifespan in males and females, but the manipulations produce divergent transcriptional responses in head tissues, including distinct effects on insulin signaling, stress-response, and metabolic pathways. 

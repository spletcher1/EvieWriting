...
Previous work established that ER2 neurons are required for death perception to accelerate aging \citep{gendron2023} and, interestingly, that constitutive activation of ER2/ER4 neurons using heat-gated TRPA1 modestly reduced lifespan \citep{gendron2023}. 
Together with the data reported here, it seems apparent that the timing and persistance of signal intensity are important for defining ER-neuron-dependent neural states and their effects on aging, which is consistent with the context-sensitivity of valence that we observed.

...
Unless otherwise specified, flies were collected 0-1 days after eclosion, transferred to 10\% sucrose/10\% yeast (SY10) medium, and allowed to mate for \pink{2-6} days. %6 is R4d>Chr FLIC from christmas break...maybe mention there instead? otherwise it's 2-4
Mated flies were then sorted by sex onto all-trans retinal (\pink{500 $\mu$M ATR}) SY10 medium, 20/vial, under brief CO\textsubscript{2} anesthesia. 
...
Three- to 9-day old flies were placed in randomized positions in optogenetic rigs.
...
Blocking solution was removed and a 1:500 dilution of anti-GFP \pink{(brand? catalog?)} in 5\% normal goat serum was added. 
...
PBS-T was removed and a 1:1000 dilution of \pink{anti-rabbit} Alexa Fluor 488 (Invitrogen) in 5\% normal goat serum was added. 
...
Vial position was randomized in the optogenetic rig and dark box for each time point.
...
\pink{7-8 days and 3-5 weeks; look up actual 1-month numbers(\# of days of treatment) but don't get hung up on it for now.} 
Flies were anesthetized on a cold pad and individually transferred into lanes of custom 12-lane or 14-lane chambers, then placed at 25$^{\circ}$ C in ambient light or in a dark box for appromixamtely \pink{15} minutes to wake up.
...
D-Drop does not have integrated optogenetic LEDs, making this the only behavioral assay without concurrent neuron activation/inhibition. 
Light-treated flies were instead dropped under ambient light conditions, with a ring light (for recording) contributing additional light. 
Dark controls, though kept light-naive until the assay, were also subjected to this ring light during recording.
...
\pink{Blah}-day old light-naive flies were aspirated into individual lanes of a multi-lane rectangular arena ((\figref{fig:arenafig}A).
...
%check that i did in fact use latin squares for everyone
For bulk head and body transcriptomics, 3- to 6-day old female flies were placed into optogenetic rigs (positions randomized within \hl{Latin squares)} or maintained in the dark in the same incubator for 1 week, after which they were flash-frozen in liquid nitrogen.
...
Heads and bodies were sorted using a sieve and counted into \pink{ribolyzer} tubes in a petri dish on dry ice.
Ten heads or 5 bodies (ER2 only) were grouped per sample, and 5 samples were sequenced per condition. \eh{(Should I mention that the bodies are a separate batch?)} 
RNA was extracted using the New England BioLabs Inc. (NEB) Monarch Total RNA Miniprep Kit (T2010S). 
Samples were lysed in 800 $\mu$L of the kit's lysis buffer at 6.5 m/s for 15 seconds in a \pink{ribolyzer}.
...
Six samples of 30 whole female bodies were sent to the University of Washington's metabolomics core for analysis. \eh{care of Ben?}

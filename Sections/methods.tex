...
Eggs were collected from grape juice agar as described in Gendron et al., 2023, and 32 $\mu$L of eggs were aliquoted into bottles containing 25-50 mL of CT larval growth medium \citep{skorupa2008}. 
...
Unless otherwise specified, flies were collected 0-1 days after eclosion, transferred to 10\% sucrose/10\% yeast (SY10) medium, and allowed to mate for 2-3 days.
...
After being sorted onto ATR food, flies were placed in a dark box for at least 1 day to allow enough time for all-trans retinal uptake before light stimulation. 
...
Light-naïve flies for behavioral assays were maintained for 1 week in the dark box to age-match 1-week light-treated flies.
...
Flies were 3-9 days old when entering light.
Experimental and control genotypes were established in parallel and were generally age-matched.
Flies were exposed to 12 V (red) or 17-20 V (green) light during ZT 0-12.
Unless otherwise specified, stimuli were delivered continuously throughout this interval at 40 Hz with a 32\% duty cycle.
Male ER2>Chr flies received an intermittent stimulation schedule consisting of 6 min on and 12 min off cycles during ZT 0-12.
...
Counting frequency increased as the experiment progressed, as starving vials often go extinct within a short window. 
...
Brain dissections, immunostaining, and imaging were performed largely as described previously \citep{gendron2023}, with minor modifications.
...
Brains were then mounted for imaging as described above. 
...
Light-naïve flies were sorted 10/vial instead of 20/vial for overnight ATR pre-treatment, to allow for direct flipping into con-ex vials without anesthesia the following day. 
...
Dye deposited on walls was washed by vortexing 3 mL of DI water in each vial. 
...
After recording, flies were given an additional 30 sec to recover (60 total sec between drops).
...
Flies were allowed to mate for 2-6 days before sorting onto ATR, and started light treatment (or aging in dark box) at 3-7 days post-eclosion. 
Light-naïve flies were aged for 7-12 days in dark before assays. 
Flies assigned to the 1-week time point received 7-14 days of pre-treatment before testing.
One-month time points were pre-treated for 28-29 days.

Data were pooled from three replicates and analyzed using R code developed in-house: \url{https://github.com/PletcherLab/FLIC_R_Code} (minimum feeding threshold = 10, event gap = 5, tasting threshold = (0, 10)).
...
Young light-naïve flies (< 21 days post-eclosion) were aspirated into individual lanes of a multi-lane rectangular arena (\figref{fig:arenafig}A).
Flies were given 10 minutes to acclimate to the arena in the dark, after which one half of the transparent arena floor was illuminated for 60 min (5 sec on/5 sec off).
...
The illuminated side of the arena was varied between replicates.
Data were pooled across 2-3 replicates.
...
\subsection*{RNA sequencing data processing and statistical analysis}
...
Heatmaps of log2-transformed normalized counts of differentially expressed genes were generated using the pheatmap R package (v 1.0.13) \citep{pheatmap}, with hierarchical clustering (Euclidean distance, complete linkage) and row-wise z-score scaling.
...
Six samples of 30 whole female bodies were sent to the University of Washington's metabolomics core for analysis. 
Approximately 10 mg of body tissue samples were homogenized in cold Milli-Q water and metabolites were extracted with methanol containing isotopically labeled internal standards ($^{13}$C-glucose and $^{13}$C-glutamic acid).
Samples were vortexed, incubated at -20$^{\circ}$C, sonicated, and centrifuged at 14,000 rpm for 15 minutes at 4$^{\circ}$C.
Supernatants were collected, dried under vacuum, and stored at -80$^{\circ}$C.
Prior to analysis, dried extracts were reconstituted in a hydrophilic interaction liquid chromatography (HILIC) solvent consisting of a 30:70 mixture of mobile phases A1 (10 mM ammonium acetate in 95\% H$_2$O/3\% acetonitrile/2\% methanol + 0.2\% acetic acid) and B1 (10 mM ammonium acetate in 93\% acetonitrile/5\% water/2\% methanol + 0.2\% acetic acid), supplemented with $^{13}$C-lactate and $^{13}$C-tyrosine internal standards.
Reconstituted samples were centrifuged at 14,000 rpm for 5 minutes at 4$^{\circ}$C and transferred to LC vials for mass spectrometry.

Targeted metabolomics data from bodies were analyzed using a 2$\times$2 factorial design with treatment (light vs. dark) and genotype (ER2>Chr vs. ER2>WCS) as factors. 
